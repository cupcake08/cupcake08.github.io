...
class TerminalController {
  final List<TerminalEntry> history = [TerminalEntry(command: '', output: ResumeData.intro)];
  ...
  bool processCommand(String input) {
    ...
    switch (cmd) {
      ...
      case 'typing':
        response = "";
        widget = const MonkeytypePortfolioSection();
        break;
      default:
        response = "bash: $cmd: command not found. Type 'help'.";
    }

    history.add(TerminalEntry(command: input, output: response, widget: widget));
    return false;
  }
}
